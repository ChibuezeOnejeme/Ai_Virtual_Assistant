...
__all__ = [
    'SAFTADPCM_8kHzStereo', 'SpeechGrammarTagWildcard',
    'SPVPRI_ALERT', 'DISPID_SGRSTransitions', 'SPSHORTCUTPAIRLIST',
    'SDTPronunciation', 'DISPID_SPIEngineId', 'SGRSTTDictation',
    'SPEI_SOUND_START', 'DISPID_SOTRemoveStorageFileName',
    'SPRS_ACTIVE', 'ISpStreamFormatConverter', 'DISPID_SVVoice',
    'ISpeechLexiconPronunciation', 'SpeechAllElements',
    'DISPID_SPRulesCount', 'DISPID_SRGId', 'SP_VISEME_14',
    'DISPID_SRGDictationSetState', 'DISPID_SVSVisemeId',
    'SVF_Stressed', 'SPEI_ADAPTATION', 'SREHypothesis',
    'SSTTDictation', 'DISPID_SRGSetTextSelection', 'DISPID_SGRsItem',
    'DISPID_SPAPhraseInfo', 'DISPID_SPELexicalForm',
    'SPINTERFERENCE_NOSIGNAL', 'SPAO_NONE', 'SSFMOpenReadWrite',
    'SpeechRetainedAudioOptions', 'SpTextSelectionInformation',
    'SAFTGSM610_22kHzMono', 'SPEI_VISEME', 'SAFT12kHz16BitStereo',
    'SGLexicalNoSpecialChars', 'SVP_0', 'SGRSTTEpsilon',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_10',
    'DISPID_SOTRemove', 'SAFTADPCM_22kHzStereo',
    'DISPID_SVEventInterests', 'eLEXTYPE_RESERVED9',
    'DISPID_SBSWrite', 'ISpeechDataKey', 'DISPID_SOTCSetId',
    'SSSPTRelativeToEnd', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPIReplacements', 'DISPID_SPARecoResult',
    'DISPID_SRGetPropertyString', 'DISPID_SpeechAudioFormat',
    'DISPID_SRDisplayUI', 'ISpeechGrammarRuleStateTransition',
    'SDA_One_Trailing_Space', 'DISPID_SVSLastBookmark', 'SPSMF_UPS',
    'SpeechLoadOption', 'SPAS_STOP', 'SVF_Emphasis', 'SpMMAudioEnum',
    'SP_VISEME_6', 'SPVPRI_NORMAL', 'SVP_3',
    'SAFTExtendedAudioFormat', 'SWTDeleted', 'SGSEnabled',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPRDisplayAttributes',
    'DISPID_SCSBaseStream', 'DISPID_SRCResume',
    'ISpeechResourceLoader', 'SPPHRASERULE', 'eLEXTYPE_PRIVATE2',
    'SSFMOpenForRead', 'ISpStreamFormat', 'SpFileStream',
    'ISpeechObjectTokenCategory', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRRTStreamTime', 'DISPID_SLPType', 'SITooFast',
    'SAFT8kHz8BitStereo', 'SPEI_RESERVED3', 'SpeechLexiconType',
    'ISpRecoGrammar', '_ISpeechVoiceEvents', 'DISPID_SABIEventBias',
    'DISPID_SVEAudioLevel', 'DISPID_SGRSTsCount',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_RECO_STATE_CHANGE',
    'Speech_Default_Weight', 'DISPID_SpeechVoiceStatus',
    'SP_VISEME_5', 'SSFMCreateForWrite', 'DISPID_SRRSpeakAudio',
    'DISPID_SRGCommit', 'DISPID_SLWsCount', 'ISpeechPhraseRule',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SBSSeek', 'SpAudioFormat', 'DISPID_SDKGetBinaryValue',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPRuleEngineConfidence', 'SLTUser', 'SREAudioLevel',
    'SECFIgnoreWidth', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRCEventInterests', 'DISPID_SVSLastBookmarkId',
    'SPRST_ACTIVE', 'DISPID_SOTCDefault', 'SRTSMLTimeout',
    'ISpeechPhraseReplacement', 'DISPID_SPRs_NewEnum',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechPhraseElement',
    'SSSPTRelativeToStart', 'SpNullPhoneConverter',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPRuleName', 'SDTRule', 'SpeechTokenIdUserLexicon',
    'SPWORDLIST', 'SpeechRuleAttributes', 'SpeechRecoContextState',
    'DISPID_SVAlertBoundary', 'SAFTText', 'SGDSActiveUserDelimited',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRsFindRule',
    'DISPID_SpeechPhraseRule', 'DISPID_SLPPhoneIds',
    'DISPID_SOTDataKey', 'SVP_8', 'DISPID_SAFType', 'DISPID_SOTCId',
    'SRCS_Enabled', 'DISPID_SASState', 'DISPID_SOTGetStorageFileName',
    'ISpRecognizer2', 'SPSHORTCUTTYPE', 'SPSLMA', 'SPGS_EXCLUSIVE',
    'SAFT12kHz16BitMono', 'STCAll', 'SPAS_CLOSED',
    'DISPID_SpeechMemoryStream', 'DISPID_SABIBufferSize',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPRsCount', 'SRARoot',
    'DISPID_SLWsItem', 'SPEI_RECO_OTHER_CONTEXT', 'SVF_None',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRESoundEnd', 'SPPS_Modifier',
    'SGRSTTRule', 'SPWORD', 'SPADAPTATIONRELEVANCE',
    'SpeechBookmarkOptions', 'ISpeechRecognizer', 'SpeechRecoEvents',
    'SGRSTTTextBuffer', 'SPEI_SR_PRIVATE',
    'SpeechPropertyAdaptationOn', 'DISPID_SVEWord',
    'DISPID_SGRSTText', 'ISpeechPhraseProperty',
    'SPEI_END_INPUT_STREAM', '_RemotableHandle', 'DISPID_SVRate',
    'DISPID_SRCEInterference', 'SPSHT_NotOverriden',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpPhoneConverter',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRRTLength',
    'SPEI_SR_BOOKMARK', 'SINoise', 'SVP_11', 'SITooLoud',
    'DISPID_SOTCreateInstance', 'ISpeechLexiconWord', 'SREStreamEnd',
    'SP_VISEME_15', 'SpeechRuleState', 'eLEXTYPE_PRIVATE3',
    'ISpeechFileStream', 'DISPID_SGRSTNextState',
    'DISPID_SPILanguageId', 'SPGS_DISABLED', 'SPDKL_CurrentUser',
    'DISPID_SDKCreateKey', 'DISPID_SPAStartElementInResult',
    'DISPID_SRRTTickCount', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechLexiconProns', 'DISPID_SBSFormat',
    'SAFT48kHz16BitMono', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SOTCEnumerateTokens', 'ISpShortcut', 'SPWT_PRONUNCIATION',
    'DISPID_SPAsItem', 'SPFILEMODE', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRIsUISupported', 'DISPID_SpeechPhraseElements',
    'SGPronounciation', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPRULE', 'DISPID_SVESentenceBoundary',
    'DISPID_SASCurrentSeekPosition', 'SPPS_RESERVED4',
    'SPEI_RESERVED5', '__MIDL_IWinTypes_0009', 'SVSFParseSsml',
    'DISPID_SGRSTType', 'SAFT32kHz8BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_SR_RETAINEDAUDIO',
    'SPAUDIOOPTIONS', 'SPINTERFERENCE_TOOQUIET',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SRERecoOtherContext',
    'DISPID_SGRs_NewEnum', 'DISPID_SWFEExtraData',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_PRIVATE13', 'SECFNoSpecialChars',
    'DISPID_SDKDeleteValue', 'DISPID_SGRSTs_NewEnum', 'ISpPhraseAlt',
    'DISPID_SPPParent', 'DISPID_SPRuleNumberOfElements',
    'SpeechVisemeType', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SFTInput',
    'DISPID_SRIsShared', 'DISPID_SMSAMMHandle',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_PRIVATE10',
    'SAFT8kHz8BitMono', 'SVP_21', 'SPCONTEXTSTATE',
    'DISPID_SLGetPronunciations', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SpeechAudioStatus', 'SGDSInactive',
    'DISPID_SGRInitialState', 'DISPID_SLWType', 'SPWORDPRONUNCIATION',
    'SPEI_MAX_SR', 'ISequentialStream', 'SAFT16kHz8BitStereo',
    'DISPID_SPPs_NewEnum', 'DISPID_SVEPhoneme', 'SREStreamStart',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechFileStream',
    'DISPID_SOTDisplayUI', 'DISPID_SPERetainedStreamOffset',
    'SPEI_START_SR_STREAM', 'SDA_Two_Trailing_Spaces',
    'SPWORDPRONUNCIATIONLIST', 'SpeechCategoryVoices',
    'DISPID_SASFreeBufferSpace', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVPriority', 'SpeechTokenKeyUI', 'DISPID_SVSRunningState',
    'ISpRecognizer3', 'DISPID_SFSOpen', 'SpMemoryStream',
    'DISPID_SVAudioOutput', 'DISPID_SLWLangId',
    'DISPID_SPIEnginePrivateData', 'SDTAlternates',
    'DISPID_SRCERequestUI', 'DISPID_SGRSAddSpecialTransition',
    'SpUnCompressedLexicon', 'DISPID_SLGetGenerationChange',
    'ISpeechPhraseInfoBuilder', 'ISpPhrase', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SGRSAddRuleTransition', 'STCRemoteServer',
    'SpeechAudioProperties', 'SAFT32kHz16BitStereo',
    'SPPHRASEPROPERTY', 'SRTAutopause',
    'DISPID_SpeechPhraseAlternates', 'SPEI_TTS_AUDIO_LEVEL',
    'IEnumString', 'ISpDataKey', 'SpeechTokenValueCLSID',
    'SDTProperty', 'DISPID_SRGRules', 'SVP_10',
    'ISpeechAudioBufferInfo', 'SPEVENT', 'DISPID_SASNonBlockingIO',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPAR_Unknown',
    'eLEXTYPE_LETTERTOSOUND', '_ISpeechRecoContextEvents',
    'ISpObjectWithToken', 'DISPID_SABufferInfo', 'ISpProperties',
    'SECFEmulateResult', 'DISPID_SRGCmdSetRuleState',
    'SpeechStreamSeekPositionType', 'ISpMMSysAudio',
    'DISPID_SABIMinNotification', 'DISPID_SVSCurrentStreamNumber',
    'SVP_5', 'SRSActive', 'SRATopLevel', 'DISPID_SAFGuid',
    'SPPS_Verb', 'DISPID_SPERetainedSizeBytes', 'SAFT22kHz8BitMono',
    'SP_VISEME_9', 'SAFT44kHz8BitStereo', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSTRule', '_SPAUDIOSTATE', 'ISpeechPhraseProperties',
    'SRADynamic', 'SPPS_Interjection', 'SREAdaptation',
    'SpeechGrammarWordType', 'SREAllEvents', 'SPSERIALIZEDPHRASE',
    'STCInprocHandler', 'SP_VISEME_19', 'SVSFParseSapi',
    'DISPID_SOTCategory', 'SPSHT_EMAIL', 'SPDKL_DefaultLocation',
    'DISPIDSPTSI_ActiveOffset', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVSFParseAutodetect', 'DISPID_SLPLangId', 'eLEXTYPE_PRIVATE5',
    'ISpNotifySink', 'SGRSTTWord', 'DISPID_SRSClsidEngine',
    'SPEVENTENUM', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpNotifyTranslator', 'SPSNoun', 'ISpRecoContext2',
    'WAVEFORMATEX', 'SPFM_NUM_MODES', 'SpeechCategoryRecognizers',
    'SPSHT_OTHER', 'SPEI_INTERFERENCE', 'DISPID_SVAudioOutputStream',
    'DISPID_SDKSetStringValue', 'DISPID_SPEAudioTimeOffset',
    'SINoSignal', 'DISPID_SVVolume', 'ISpResourceManager',
    'SpeechPropertyLowConfidenceThreshold', 'SDA_No_Trailing_Space',
    'DISPID_SPEPronunciation', 'DISPIDSPTSI_ActiveLength',
    'SPFM_OPEN_READWRITE', 'ISpRecognizer', 'SpVoice',
    'SPEI_SENTENCE_BOUNDARY', 'eLEXTYPE_RESERVED4', 'SVP_16',
    'SRAExport', 'SVSFNLPSpeakPunc', 'SPWF_INPUT',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCESoundStart',
    'DISPID_SOTs_NewEnum', 'SPTEXTSELECTIONINFO',
    'SECNormalConfidence', 'SPSNotOverriden',
    'ISpPhoneticAlphabetSelection', 'SPAS_RUN', 'SVSFIsNotXML',
    'SITooQuiet', 'ISpeechLexicon', 'SpeechPropertyResourceUsage',
    'DISPID_SMSSetData', 'SVEViseme', 'DISPID_SpeechRecognizerStatus',
    'SpCustomStream', 'eLEXTYPE_RESERVED6', 'SRSInactive',
    'DISPID_SVEStreamEnd', 'DISPID_SPRules_NewEnum', 'SPRECOSTATE',
    'DISPID_SRGRecoContext', 'SAFT24kHz16BitStereo', 'SPAR_High',
    'DISPID_SPEActualConfidence', 'DISPID_SRState',
    'SpObjectTokenCategory', 'DISPID_SPPName',
    'DISPID_SABufferNotifySize',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPRNumberOfElements', 'DISPID_SRGReset',
    'DISPID_SGRAttributes', 'SP_VISEME_13', 'SLTApp',
    'DISPID_SGRsCommit', 'SpResourceManager', 'SRTEmulated',
    'DISPID_SAEventHandle', 'DISPID_SpeechAudio',
    'SpeechPropertyResponseSpeed', 'SVP_14', 'DISPID_SPIGrammarId',
    'DISPID_SpeechPhraseInfo', 'SpeechRunState',
    'DISPID_SVSyncronousSpeakTimeout',
    'SpeechPropertyNormalConfidenceThreshold', 'SPAR_Medium',
    'SPEI_TTS_BOOKMARK', 'SDKLDefaultLocation',
    'DISPID_SPIProperties', 'Speech_StreamPos_Asap',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCBookmark',
    'SPPS_NotOverriden', 'STSF_CommonAppData',
    'DISPID_SpeechPhraseAlternate', 'SPEI_RECOGNITION',
    'DISPID_SpeechDataKey', 'SSSPTRelativeToCurrentPosition',
    'SRERecognition', 'DISPID_SDKGetStringValue',
    'ISpeechRecoResult2', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SpeechVoice', 'SPSEMANTICFORMAT', 'DISPID_SVResume',
    'SPPHRASE', 'eLEXTYPE_PRIVATE11', 'SPEI_PHONEME',
    'eWORDTYPE_ADDED', 'SPPARTOFSPEECH', 'SpCompressedLexicon',
    ...
    'SpeechDataKeyLocation', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SpeechLexicon', 'SP_VISEME_11', 'DISPID_SRCPause',
    'DISPID_SVDisplayUI', 'DISPID_SWFEBlockAlign', 'SPBO_PAUSE',
    'DISPID_SPIGetText', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRRGetXMLResult', 'DISPID_SOTIsUISupported',
    'DISPID_SpeechLexiconWord', 'SREStateChange',
    'SpInProcRecoContext', 'DISPID_SVSInputSentenceLength',
    'SpeechTokenKeyFiles', 'DISPID_SRCRecognizer',
    'DISPID_SGRAddResource', 'SECFIgnoreKanaType',
    'DISPID_SVSInputSentencePosition', 'SVP_18',
    'DISPID_SASCurrentDevicePosition', 'SVSFParseMask', 'SECFDefault',
    'ISpXMLRecoResult', 'DISPID_SPIStartTime',
    'DISPID_SAFSetWaveFormatEx', 'STSF_AppData',
    'DISPID_SRCVoicePurgeEvent', 'SRCS_Disabled',
    'DISPID_SVEStreamStart', 'DISPID_SBSRead',
    'DISPID_SPEAudioSizeTime', 'IInternetSecurityManager',
    'SAFT32kHz16BitMono', 'SAFT48kHz8BitStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SWFEBitsPerSample',
    'SpeechTokenKeyAttributes', 'SAFTDefault',
    'DISPID_SGRSTPropertyName', 'DISPID_SVGetVoices',
    'DISPID_SRCEStartStream', 'DISPID_SVEEnginePrivate',
    'SWPUnknownWordPronounceable', 'ISpeechLexiconWords',
    'DISPID_SPEsItem', 'SPRECORESULTTIMES',
    'DISPID_SRGDictationUnload', 'SAFTGSM610_11kHzMono',
    'SpStreamFormatConverter', 'SpeechRegistryLocalMachineRoot',
    'SASPause', 'SRESoundStart', 'DISPID_SFSClose',
    'DISPID_SGRAddState', 'SAFT11kHz16BitMono', 'SPCT_SUB_COMMAND',
    'SpPhoneConverter', 'DISPID_SPRText', 'DISPID_SVSLastResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SBONone',
    'SAFT22kHz8BitStereo', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPRuleId', 'eWORDTYPE_DELETED', 'SpMMAudioIn',
    'SpeechTokenContext', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechObjectTokens', 'SRSEIsSpeaking',
    'eLEXTYPE_PRIVATE19', 'SGDSActiveWithAutoPause',
    'SPWORDPRONOUNCEABLE', 'SpeechRecognizerState', 'ISpeechAudio',
    'DISPID_SPPConfidence', 'ISpeechWaveFormatEx',
    'DISPID_SRCRequestedUIType', 'DISPID_SPPsItem',
    'SECLowConfidence', 'SASStop', 'SpeechVoiceEvents',
    'SREFalseRecognition', 'SVSFlagsAsync', 'eLEXTYPE_PRIVATE17',
    'SAFTADPCM_11kHzMono', 'DISPID_SREmulateRecognition',
    'SAFT12kHz8BitMono', 'DISPID_SWFEFormatTag', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPPNumberOfElements', 'SPLO_STATIC',
    'DISPID_SPIAudioSizeTime', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SLPsItem', 'DISPID_SRRPhraseInfo', 'ISpVoice',
    'SPSModifier', 'SP_VISEME_1', 'DISPID_SVEBookmark', 'SGDSActive',
    'SPPS_RESERVED2', 'DISPID_SAVolume', 'DISPID_SRCEPhraseStart',
    'SPRST_INACTIVE', 'ISpeechPhraseRules', 'ISpRecoContext',
    'DISPID_SpeechWaveFormatEx', 'LONG_PTR', 'SAFT8kHz16BitMono',
    'ISpeechAudioFormat', 'DISPID_SGRsAdd', 'SPVPRI_OVER',
    'SPWORDTYPE', 'SPINTERFERENCE_TOOFAST', 'SP_VISEME_8',
    'SpeechCategoryAudioOut', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechXMLRecoResult', 'DISPIDSPRG', 'SAFTCCITT_ALaw_8kHzMono',
    ...
    'DISPID_SGRName', 'DISPID_SpeechMMSysAudio', 'SPCS_ENABLED',
    'ISpAudio', 'SP_VISEME_16', 'SVESentenceBoundary', 'SVEPrivate',
    'SRAImport', 'SPEI_FALSE_RECOGNITION', 'SPWF_SRENGINE',
    'SPDKL_LocalMachine', 'SPSInterjection', 'SPFM_CREATE',
    'DISPID_SWFEAvgBytesPerSec', 'IInternetSecurityMgrSite',
    'SSTTWildcard', 'SPPROPERTYINFO', 'DISPID_SOTGetDescription',
    'DISPID_SOTSetId', 'SVP_7', 'DISPID_SRRTOffsetFromStart',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechBaseStream',
    'DISPID_SOTId', 'SpSharedRecognizer', 'SAFTGSM610_44kHzMono',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCEEndStream',
    'ISpeechGrammarRuleState', 'eLEXTYPE_PRIVATE4', 'SRERequestUI',
    'eLEXTYPE_PRIVATE18', 'SREPrivate', 'DISPID_SVSpeakStream',
    'SFTSREngine', 'SpObjectToken', 'DISPID_SpeechGrammarRule',
    'SPWT_LEXICAL', 'DISPID_SpeechPhraseProperties',
    'ISpeechPhraseElements', 'SpeechVoiceSpeakFlags', 'SPCT_COMMAND',
    'DISPID_SpeechGrammarRules',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPCT_SUB_DICTATION',
    'SpeechCategoryRecoProfiles', 'DISPID_SRRTimes',
    'tagSPPROPERTYINFO', 'SpSharedRecoContext', 'ISpObjectToken',
    'SPXRO_Alternates_SML', 'SREInterference', 'SP_VISEME_3',
    'SpeechInterference', 'DISPID_SpeechVoiceEvent', 'SPBO_AHEAD',
    'SPPS_Function', 'ISpeechGrammarRules', 'DISPID_SPIRule',
    'DISPID_SPRuleParent', 'SVP_12', 'SPLOADOPTIONS',
    'SpeechAudioFormatType', 'SAFT44kHz8BitMono', 'DISPID_SVPause',
    'eLEXTYPE_APP', 'SpeechUserTraining', 'SpeechMicTraining',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPLO_DYNAMIC',
    'SpeechRecognitionType', 'SREPhraseStart',
    'SpeechGrammarTagDictation', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPISaveToMemory', 'SP_VISEME_0', 'SPSTREAMFORMATTYPE',
    'DISPID_SPAsCount', 'DISPID_SRSetPropertyString',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SpeechPhraseRules',
    'SPAUDIOSTATE', 'DISPID_SPRulesItem', 'SVEAudioLevel',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPRS_INACTIVE',
    'DISPID_SRCRetainedAudio', 'SAFT48kHz16BitStereo',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRCSetAdaptationData',
    'ISpeechPhraseElement', 'ISpeechPhraseAlternate',
    'SpeechAudioFormatGUIDWave', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVGetAudioOutputs',
    'SPSHT_Unknown', 'SRTReSent', 'eLEXTYPE_PRIVATE7',
    'SDTDisplayText', 'SAFTGSM610_8kHzMono', 'SGSExclusive',
    'SAFT24kHz8BitStereo', 'SPPS_Noun', 'SSTTTextBuffer',
    'SpeechVoicePriority', 'ISpEventSource', 'DISPID_SRRSaveToMemory',
    'SGDisplay', 'SVSFIsXML', 'DISPID_SOTsItem', 'SAFT24kHz8BitMono',
    'SpeechVisemeFeature', 'SPEI_SOUND_END',
    'DISPID_SpeechCustomStream', 'DISPID_SDKGetlongValue',
    'ISpeechRecoResultTimes', 'SVSFDefault', 'SAFTADPCM_44kHzMono',
    'SpeechStreamFileMode', 'SpPhoneticAlphabetConverter',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVEPhoneme',
    'SVPNormal', 'SP_VISEME_17', 'ISpeechPhraseInfo', 'UINT_PTR',
    'SVSFIsFilename', 'SpeechRegistryUserRoot',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT48kHz8BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SLOStatic',
    'SPPS_Unknown', 'SpeechFormatType', 'DISPID_SLAddPronunciation',
    ...
    'DISPID_SLPs_NewEnum', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechXMLRecoResult', 'ISpPhoneticAlphabetConverter',
    'SP_VISEME_20', 'SPCT_DICTATION', 'SAFT8kHz16BitStereo',
    'SVEBookmark', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechSpecialTransitionType', 'DISPID_SVSInputWordPosition',
    'SPGRAMMARSTATE', 'DISPID_SWFEChannels',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechRecoResult2',
    'SVSFNLPMask', 'SRAORetainAudio', 'SPEI_MAX_TTS',
    'STSF_FlagCreate',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_18',
    'SDKLLocalMachine', 'SPAS_PAUSE', 'SAFT16kHz8BitMono',
    'DISPIDSPTSI', 'DISPID_SpeechRecoResult', 'SBOPause', 'SPBO_NONE',
    'ISpeechCustomStream', 'DISPID_SRCState', 'eLEXTYPE_USER',
    'SP_VISEME_12', 'SpeechCategoryAudioIn', 'SGRSTTWildcard',
    'DISPID_SVSInputWordLength', 'SP_VISEME_21',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechObjectTokenCategory',
    'SINone', 'ISpeechRecognizerStatus', 'ISpeechObjectToken',
    'SpMMAudioOut', 'IEnumSpObjectTokens', 'SGLexical',
    'SAFTCCITT_ALaw_22kHzStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT44kHz16BitStereo',
    'eLEXTYPE_PRIVATE6', 'SAFT32kHz8BitMono', 'SPRST_ACTIVE_ALWAYS',
    'Speech_Max_Pron_Length', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRGCmdLoadFromFile',
    'SAFT22kHz16BitStereo', 'SPSVerb', 'DISPID_SLGetWords',
    'SPEI_MIN_SR', 'DISPID_SDKEnumValues', 'SDTAudio', 'SpLexicon',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SOTGetAttribute',
    'DISPID_SPPChildren', 'DISPID_SPIAudioSizeBytes',
    'SPDATAKEYLOCATION', 'SpPhraseInfoBuilder', 'SVP_19',
    'DISPID_SLWWord', 'SPBINARYGRAMMAR', 'eLEXTYPE_PRIVATE15',
    'SASClosed', 'DISPID_SRRRecoContext', 'SPPS_SuppressWord',
    'DISPID_SRRAlternates', 'SVP_2', 'SRSInactiveWithPurge',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCERecognition',
    'SPEI_VOICE_CHANGE', 'DISPID_SPPFirstElement',
    'eLEXTYPE_RESERVED10', 'DISPID_SRSNumberOfActiveRules',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRSetPropertyNumber',
    'DISPID_SVSkip', 'SAFT11kHz8BitStereo',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechObjectToken', 'SVPOver',
    'DISPID_SRCEAdaptation', 'SITooSlow', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFT12kHz8BitStereo', 'DISPID_SPCLangId', 'SDTReplacement',
    'SDTLexicalForm', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRCVoice', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechTextSelectionInformation', 'SPRECOGNIZERSTATUS',
    'SAFT16kHz16BitMono', 'SAFTADPCM_44kHzStereo', 'SVP_17',
    'SpeechEmulationCompareFlags', 'ISpNotifySource',
    'SPWAVEFORMATTYPE', 'DISPID_SGRSTWeight', 'SVPAlert',
    'DISPID_SRRAudio', 'DISPID_SLWPronunciations', 'tagSTATSTG',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT11kHz8BitMono',
    'SDKLCurrentUser', 'DISPID_SGRsCommitAndSave',
    'SAFT11kHz16BitStereo', 'DISPID_SRSAudioStatus', 'SP_VISEME_7',
    'SPBO_TIME_UNITS', 'SVSFVoiceMask',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRGState',
    'SpWaveFormatEx', 'SASRun', 'DISPID_SGRSRule',
    'DISPID_SRGetRecognizers', 'SpeechRecoProfileProperties',
    'DISPID_SDKEnumKeys', 'STCLocalServer', 'SPINTERFERENCE_TOOLOUD',
    'SpeechDiscardType', 'DISPID_SpeechPhraseProperty',
    'DISPID_SMSALineId', 'DISPID_SGRsCount', 'DISPID_SLGenerationId',
    'DISPID_SASetState', 'SPPHRASEELEMENT', 'DISPID_SVGetAudioInputs',
    'SpeechAddRemoveWord', 'DISPID_SRCCmdMaxAlternates',
    'SPEI_PHRASE_START', 'SRTStandard',
    'DISPID_SpeechGrammarRuleState', 'ISpEventSink',
    'DISPID_SLPsCount', 'SPEI_REQUEST_UI', 'SPXMLRESULTOPTIONS',
    'SWTAdded', 'SPWT_DISPLAY', 'DISPID_SRGDictationLoad',
    'SpeechPropertyComplexResponseSpeed', 'SPSERIALIZEDRESULT',
    'DISPID_SVWaitUntilDone', 'DISPID_SLPSymbolic',
    'SREPropertyNumChange', 'SPPS_LMA',
    'DISPID_SGRSAddWordTransition', 'SREBookmark',
    'SECHighConfidence', 'DISPID_SRCEBookmark', 'DISPID_SPPValue',
    'SpeechCategoryAppLexicons', 'SPVPRIORITY',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPAs_NewEnum',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SAStatus', 'SRTExtendableParse', 'DISPID_SLWs_NewEnum',
    'ISpeechGrammarRule', 'SPSSuppressWord', 'SAFTNonStandardFormat',
    'SPDKL_CurrentConfig', 'STCInprocServer',
    ...
    'DISPID_SPEsCount', 'SVEStartInputStream', 'SVEEndInputStream',
    'SpeechWordPronounceable', 'DISPID_SGRSTPropertyValue',
    'SPRULESTATE', 'SPINTERFERENCE_NOISE', 'DISPID_SRProfile',
    'SAFTADPCM_22kHzMono', 'SpInprocRecognizer', 'SVEAllEvents',
    'SPEVENTSOURCEINFO', 'DISPID_SPPsCount', 'SPEI_RESERVED1',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechRecoContext',
    'SPVISEMES', 'SDKLCurrentConfig', 'SPVOICESTATUS',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT44kHz16BitMono',
    'DISPID_SADefaultFormat', 'SPEI_RESERVED6', 'ISpeechVoiceStatus',
    'SpeechVoiceCategoryTTSRate', 'SpeechAudioState',
    'SPEI_WORD_BOUNDARY', 'SAFTADPCM_8kHzMono',
    'ISpeechPhraseReplacements', 'DISPID_SPRuleConfidence',
    'ISpStream', 'ISpeechAudioStatus', 'DISPID_SGRId',
    'DISPID_SMSGetData', 'ISpeechVoice', 'DISPID_SRRAudioFormat',
    'SPSFunction', 'SRAInterpreter', 'SECFIgnoreCase', 'SpShortcut',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_20',
    'SpeechDictationTopicSpelling', 'DISPID_SVSpeak',
    'DISPID_SVSpeakCompleteEvent', 'SPPS_RESERVED1',
    'ISpeechRecoResultDispatch', 'DISPID_SOTCGetDataKey',
    'Speech_Max_Word_Length', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVGetProfiles', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SMSADeviceId', 'DISPID_SVIsUISupported',
    'DISPID_SDKOpenKey', 'SAFT22kHz16BitMono', 'eLEXTYPE_RESERVED8',
    'SpeechEngineProperties', 'DISPID_SPRsItem', 'SpeechAudioVolume',
    'DISPID_SOTsCount', 'DISPID_SRCERecognizerStateChange',
    'SPPS_Noncontent', 'ISpSerializeState',
    'DISPID_SRRGetXMLErrorInfo', 'SpNotifyTranslator',
    'DISPID_SVSPhonemeId', 'DISPID_SGRsDynamic', 'SPSHORTCUTPAIR',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRAudioInputStream',
    'SPFM_CREATE_ALWAYS', 'SDTAll', 'ISpeechMemoryStream',
    'DISPID_SGRSTsItem', 'ISpRecoCategory', 'DISPID_SPRuleChildren',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPPId',
    'SPFM_OPEN_READONLY', 'SPEI_TTS_PRIVATE', 'SRSActiveAlways',
    'SpeechAudioFormatGUIDText', 'SPEI_RESERVED2',
    'tagSPTEXTSELECTIONINFO', 'SGSDisabled', 'SAFTNoAssignedFormat',
    'SPAR_Low', 'SPSMF_SRGS_SAPIPROPERTIES', 'SSFMCreate',
    'SP_VISEME_4', 'SPSUnknown', 'SPLEXICONTYPE', 'SPBOOKMARKOPTIONS',
    'DISPID_SPEAudioStreamOffset', 'SpeechCategoryPhoneConverters',
    'ISpGrammarBuilder', 'SPCATEGORYTYPE',
    'DISPID_SRCEFalseRecognition', 'SPPHRASEREPLACEMENT',
    'ISpLexicon', 'DISPID_SDKSetLongValue', 'eLEXTYPE_PRIVATE8',
    'DISPID_SVEViseme', 'DISPID_SVEVoiceChange',
    'DISPID_SPRFirstElement', 'SVEWordBoundary', 'SVP_13',
    'DISPID_SpeechRecognizer', 'SPPS_RESERVED3',
    'SpeechDisplayAttributes', 'SRAONone',
    'DISPID_SRCreateRecoContext', 'SPSEMANTICERRORINFO',
    'ISpeechRecoGrammar', 'DISPID_SRGCmdLoadFromResource',
    'ISpeechObjectTokens', 'SPCS_DISABLED', 'DISPID_SPEDisplayText',
    'DISPID_SGRClear', 'DISPID_SRGetFormat', 'ISpeechRecoResult',
    'SVP_6', 'SpStream', 'IStream', 'SVP_9', 'SPRST_NUM_STATES',
    'SREPropertyStringChange', 'SPSMF_SAPI_PROPERTIES',
    'SAFT24kHz16BitMono', 'ISpeechLexiconPronunciations',
    'DISPID_SRRecognizer', 'SPXRO_SML', 'SPCT_SLEEP',
    'SpeechVoiceSkipTypeSentence', 'eLEXTYPE_RESERVED7',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPEs_NewEnum', 'SVSFUnusedFlags',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechMMSysAudio', 'SPEI_END_SR_STREAM', 'SPINTERFERENCE_NONE',
    'SPGRAMMARWORDTYPE', 'SpeechWordType',
    'DISPID_SPEDisplayAttributes', 'Speech_StreamPos_RealTime',
    'SPGS_ENABLED', 'SWPUnknownWordUnpronounceable', 'SRSEDone',
    'SP_VISEME_2', 'SLODynamic', 'DISPID_SGRSTPropertyId',
    'SPEI_START_INPUT_STREAM', 'SPAO_RETAIN_AUDIO', 'SVSFPersistXML',
    'SPEI_MIN_TTS', 'SVP_15', 'ISpeechBaseStream',
    'ISpeechPhoneConverter', 'SVP_4', 'SPAUDIOBUFFERINFO',
    'SpeechPartOfSpeech', 'DISPID_SRCCreateGrammar', 'SVP_1',
    'SRADefaultToActive', 'DISPID_SPACommit',
    'DISPID_SPERequiredConfidence', 'SPINTERFERENCE',
    'SVEVoiceChange', 'SpeechGrammarState', 'SAFTADPCM_11kHzStereo',
    'SPAUDIOSTATUS', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_HYPOTHESIS', 'ISpeechPhraseAlternates', 'SPEI_UNDEFINED',
    'SpeechEngineConfidence'
]

_check_version('1.1.14', 1661109815.086884)
